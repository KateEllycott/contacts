...
public class Main {
    ...
    public static LocalDateTime merge(LocalDateTime dateTime1, LocalDateTime dateTime2) {
        ...
        int month = dateTime1.getMonthValue() > dateTime2.getMonthValue() ? dateTime1.getMonthValue() : dateTime2.getMonthValue();
        int day = dateTime1.getDayOfMonth() > dateTime2.getDayOfMonth() ? dateTime1.getDayOfMonth() : dateTime2.getDayOfMonth();
        int hour = dateTime1.getHour() > dateTime2.getHour() ? dateTime1.getHour() : dateTime2.getHour();
        int minute = dateTime1.getMinute() > dateTime2.getMinute() ? dateTime1.getMinute() : dateTime2.getMinute();
        int second = dateTime1.getSecond() > dateTime2.getSecond() ? dateTime1.getSecond() : dateTime2.getSecond();
